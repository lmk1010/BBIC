  ...
  <section class="content-header">
									...
									<div class="panel-body">
										<form id="formSearch" class="form-horizontal">
											<div class="form-group" style="margin-top:15px">
												...
												<label class="control-label col-sm-1"
													for="txt_search_cata">权限等级</label>
												<div class="col-sm-3">
													<select class="form-control select2" data-placeholder="Select a State" id="txt_search_cata">
												...
												<label class="control-label col-sm-1"
													for="txt_search_depart">部门</label>
												<div class="col-sm-3">
													<select  class="form-control select2"  
														id="txt_search_depart">
														<option selected="selected"></option>
														<option>函件局</option>
														<option>集邮公司</option>
														<option>人力资源</option>
    ...
    function initTable() {
        ...
        $table.bootstrapTable({
            ...
            var catagory = document.getElementById('txt_search_cata').value;
            var department = document.getElementById('txt_search_depart').value;
              var param = {    
